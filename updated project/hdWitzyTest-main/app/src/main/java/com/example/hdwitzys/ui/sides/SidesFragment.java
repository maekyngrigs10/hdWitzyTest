...
public class SidesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        setupItemButton(view, R.id.itemSideButton1, 4.50, "World's Greatest PB&J");
        setupItemButton(view, R.id.itemSideButton2, 3.00, "Shoestring Fries");
        setupItemButton(view, R.id.itemSideButton3, 4.50, "Steamed Vegetables");
        setupItemButton(view, R.id.itemSideButton4, 4.00, "Side Salad");
